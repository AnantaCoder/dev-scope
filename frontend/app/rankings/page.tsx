                        ...
                        <div className="premium-card p-6 mt-6 bg-gradient-to-r from-green-500/10 to-emerald-500/10 border-green-500/30">
                            <div className="flex flex-col sm:flex-row items-start gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <button
                                        onClick={login}
                                        className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 text-white font-medium rounded-lg transition-all shadow-lg shadow-green-500/20 hover:glow-green"
                                    >
