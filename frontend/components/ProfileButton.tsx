                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-[#8b949e] leading-relaxed">View your public profile, rankings, and activity. Perfect for exploring your GitHub stats.</p>
                      <div className="mt-2 flex items-center gap-2 text-[10px] text-green-400">
                        <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <span>No repository permissions needed</span>
                      </div>
                    </div>
                  </div>
                </button>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <p className="font-semibold text-[#e6edf3] mb-1 flex items-center gap-2">
                        Full Access
                        <span className="px-1.5 py-0.5 text-[9px] bg-purple-500/20 text-purple-300 rounded font-bold">PREMIUM</span>
                      </p>
                      <p className="text-xs text-[#8b949e] leading-relaxed">Access private repository stats, contributions, and detailed analytics. Unlock all features.</p>
